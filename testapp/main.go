...
import (
  ...
  "errors"
  "fmt"
  stiggApiClient "github.com/stiggio/api-client-go"
...
func getClient(req *http.Request) (*stigg.Client, error) {
  ...
  client, err := stiggApiClient.NewClient(apiKey, &stiggGraphUrl)
  if err != nil {
