...
type APIKeyHasExpiryDate struct {
	APIKeyID          string `json:"apiKeyId"`
	Code              string `json:"code"`
	IsValidationError bool   `json:"isValidationError"`
}
...
type BillingInvoiceStatusError struct {
	Code              string `json:"code"`
...
type CreditEntitlementSummary struct {
	...
	// The quantity of the addon subscription
	...
	// The feature entitlement this credit depends on (e.g. seats)
	DependencyFeatureEntitlement *FeatureEntitlement `json:"dependencyFeatureEntitlement"`
...
type CreditGrantAlreadyVoidedError struct {
	Code              string `json:"code"`
	GrantID           string `json:"grantId"`
	IsValidationError bool   `json:"isValidationError"`
}
...
// Credit grant cannot be voided error
type CreditGrantCannotBeVoidedError struct {
	Code string `json:"code"`
	// The auto-generated readable identifier for the credit grant
	GrantID           string `json:"grantId"`
	IsValidationError bool   `json:"isValidationError"`
...
type ImportSubscriptionInput struct {
	...
	CustomerID         string                    `json:"customerId"`
	EndDate            *string                   `json:"endDate,omitempty"`
	// Feature and credit entitlements for the subscription.
	Entitlements []*SubscriptionEntitlementInputV2 `json:"entitlements,omitempty"`
	PlanID       string                            `json:"planId"`
	ResourceID   *string                           `json:"resourceId,omitempty"`
	SalesforceID *string                           `json:"salesforceId,omitempty"`
	StartDate    *string                           `json:"startDate,omitempty"`
	// Feature entitlements for the subscription. Deprecated: use entitlements instead.
	SubscriptionEntitlements []*SubscriptionEntitlementInput `json:"subscriptionEntitlements,omitempty"`
...
type MissingBillingInvoice struct {
	Code              string `json:"code"`
	EntityID          string `json:"entityId"`
	IsValidationError bool   `json:"isValidationError"`
}
...
type NoActiveSubscriptionForCustomerError struct {
	Code              string `json:"code"`
	CustomerRefID     string `json:"customerRefId"`
	IsValidationError bool   `json:"isValidationError"`
}
...
type PackageCreditEntitlement struct {
	...
	// The feature dependency information for this entitlement (credit entitlements only). The entitlement value will be calculated based on the dependency feature usage limit
	DependencyFeature *Feature `json:"dependencyFeature"`
	// The description of the entitlement
	Description *string `json:"description"`
	// The display name override of the entitlement
	DisplayNameOverride *string `json:"displayNameOverride"`
...
type UpdateDataExportSelectionInput struct {
...
type UsageHistoryV2 struct {
	...
	Markers []*UsageMarker `json:"markers"`
	// Cursor pagination info for series groups; present only when paging input is provided.
	PageInfo *PageInfo `json:"pageInfo"`
	// Series of usage history
...
type UsageHistoryV2Input struct {
	...
	IncludeInactiveSubscriptions *bool `json:"includeInactiveSubscriptions,omitempty"`
	// Cursor pagination over series groups. When omitted, all groups are returned and no pageInfo is emitted.
	Paging *CursorPaging `json:"paging,omitempty"`
	// Resource id
	ResourceID *string `json:"resourceId,omitempty"`
	// The start date of the range
...
// The action type for API key scope permissions
type APIKeyScopeAction string

const (
	// Read access
	APIKeyScopeActionRead APIKeyScopeAction = "READ"
	// Write access
	APIKeyScopeActionWrite APIKeyScopeAction = "WRITE"
)

var AllAPIKeyScopeAction = []APIKeyScopeAction{
	APIKeyScopeActionRead,
	APIKeyScopeActionWrite,
}

func (e APIKeyScopeAction) IsValid() bool {
	switch e {
	case APIKeyScopeActionRead, APIKeyScopeActionWrite:
		return true
	}
	return false
}

func (e APIKeyScopeAction) String() string {
	return string(e)
}

func (e *APIKeyScopeAction) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = APIKeyScopeAction(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ApiKeyScopeAction", str)
	}
	return nil
}

func (e APIKeyScopeAction) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

// The resource type for API key scope permissions
type APIKeyScopeResource string
...
var AllAPIKeyScopeResource = []APIKeyScopeResource{
	APIKeyScopeResourceAPIKey,
...
func (e APIKeyScopeResource) String() string {
	return string(e)
}

func (e *APIKeyScopeResource) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = APIKeyScopeResource(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ApiKeyScopeResource", str)
	}
	return nil
}

func (e APIKeyScopeResource) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
func (e *CreditGrantType) UnmarshalGQL(v interface{}) error {
	...
	*e = CreditGrantType(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid CreditGrantType", str)
	}
	return nil
}
...
const (
	...
	// Credits consumption transfer source
	CreditLedgerEventTypeCreditsConsumptionTransferSource CreditLedgerEventType = "CREDITS_CONSUMPTION_TRANSFER_SOURCE"
	// Credits consumption transfer target
	CreditLedgerEventTypeCreditsConsumptionTransferTarget CreditLedgerEventType = "CREDITS_CONSUMPTION_TRANSFER_TARGET"
	// Credits expired
...
var AllCreditLedgerEventType = []CreditLedgerEventType{
	...
	CreditLedgerEventTypeCreditsConsumptionTransferSource,
	CreditLedgerEventTypeCreditsConsumptionTransferTarget,
...
func (e CreditLedgerEventType) IsValid() bool {
	switch e {
	case CreditLedgerEventTypeCreditsConsumed, CreditLedgerEventTypeCreditsConsumptionTransferSource, CreditLedgerEventTypeCreditsConsumptionTransferTarget, CreditLedgerEventTypeCreditsExpired, CreditLedgerEventTypeCreditsGranted, CreditLedgerEventTypeCreditsUpdated, CreditLedgerEventTypeCreditsVoided:
		return true
	}
	return false
}
...
const (
	...
	// API key has expired
	ErrorCodeAPIKeyExpired ErrorCode = "ApiKeyExpired"
	// API key has expiry date set
	ErrorCodeAPIKeyHasExpiry ErrorCode = "ApiKeyHasExpiry"
	// API key not found
	ErrorCodeAPIKeyNotFound              ErrorCode = "ApiKeyNotFound"
	...
	ErrorCodeAuthorizationServiceError                ErrorCode = "AuthorizationServiceError"
	...
	ErrorCodeBillingInvoiceStatusError ErrorCode = "BillingInvoiceStatusError"
	...
	ErrorCodeCannotUnarchiveProductError ErrorCode = "CannotUnarchiveProductError"
	// Cannot update expireAt for an expired credit grant
	ErrorCodeCannotUpdateExpireAtForExpiredCreditGrantError ErrorCode = "CannotUpdateExpireAtForExpiredCreditGrantError"
	...
	ErrorCodeCreditGrantAlreadyVoided  ErrorCode = "CreditGrantAlreadyVoided"
	ErrorCodeCreditGrantCannotBeVoided ErrorCode = "CreditGrantCannotBeVoided"
	// Credit grant not found
	ErrorCodeCreditGrantNotFound ErrorCode = "CreditGrantNotFound"
	// Custom currency not found
	ErrorCodeCustomCurrencyNotFound            ErrorCode = "CustomCurrencyNotFound"
	...
	ErrorCodeEntitlementBelongsToFeatureGroupError ErrorCode = "EntitlementBelongsToFeatureGroupError"
	...
	ErrorCodeExpireAtMustBeLaterThanEffectiveAtError ErrorCode = "ExpireAtMustBeLaterThanEffectiveAtError"
	...
	// Invoice preview is not available while the billing contract is still a draft
	ErrorCodeInvoicePreviewNotAvailableForDraftContract ErrorCode = "InvoicePreviewNotAvailableForDraftContract"
	...
	ErrorCodeMissingBillingInvoiceError ErrorCode = "MissingBillingInvoiceError"
	...
	ErrorCodeNoActiveSubscriptionForCustomer                    ErrorCode = "NoActiveSubscriptionForCustomer"
	...
	ErrorCodeObjectAlreadyBeingUsedByAnotherRequestError ErrorCode = "ObjectAlreadyBeingUsedByAnotherRequestError"
	...
	ErrorCodeSchedulingAtEndOfBillingPeriod                   ErrorCode = "SchedulingAtEndOfBillingPeriod"
	...
	ErrorCodeTooManyCustomCurrencies         ErrorCode = "TooManyCustomCurrencies"
	...
	ErrorCodeVendorIsNotSupported                ErrorCode = "VendorIsNotSupported"
...
var AllErrorCode = []ErrorCode{
	...
	ErrorCodeCannotUnarchiveProductError,
	ErrorCodeCannotUpdateExpireAtForExpiredCreditGrantError,
	...
	ErrorCodeCreditGrantAlreadyVoided,
	ErrorCodeCreditGrantCannotBeVoided,
	ErrorCodeCreditGrantNotFound,
	ErrorCodeCustomCurrencyNotFound,
	...
	ErrorCodeEntitlementBelongsToFeatureGroupError,
	...
	ErrorCodeInvoicePreviewNotAvailableForDraftContract,
	...
	ErrorCodeObjectAlreadyBeingUsedByAnotherRequestError,
	...
	ErrorCodeSchedulingAtEndOfBillingPeriod,
	...
	ErrorCodeTooManyCustomCurrencies,
...
const (
	...
	// API key created
	EventLogTypeAPIKeyCreated EventLogType = "API_KEY_CREATED"
	// API key revoked
	EventLogTypeAPIKeyRevoked EventLogType = "API_KEY_REVOKED"
	// API key rotated
	EventLogTypeAPIKeyRotated EventLogType = "API_KEY_ROTATED"
	// API key updated
	EventLogTypeAPIKeyUpdated EventLogType = "API_KEY_UPDATED"
	// Automatic recharge configuration changed
	EventLogTypeAutomaticRechargeConfigurationChanged EventLogType = "AUTOMATIC_RECHARGE_CONFIGURATION_CHANGED"
	// Automatic recharge operation attempted
	EventLogTypeAutomaticRechargeOperationAttempted EventLogType = "AUTOMATIC_RECHARGE_OPERATION_ATTEMPTED"
	// Coupon archived
	...
	// Automatic recharge limit exceeded
	EventLogTypeCreditsAutomaticRechargeLimitExceeded EventLogType = "CREDITS_AUTOMATIC_RECHARGE_LIMIT_EXCEEDED"
	// Deprecated, use CREDIT_BALANCE_DEPLETED instead
	EventLogTypeCreditsBalanceDepletedOld EventLogType = "CREDITS_BALANCE_DEPLETED_OLD"
	// Deprecated, use CREDIT_BALANCE_LOW instead
	EventLogTypeCreditsBalanceLowOld EventLogType = "CREDITS_BALANCE_LOW_OLD"
	// Deprecated, use CREDIT_GRANT_BALANCE_LOW instead
	EventLogTypeCreditsGrantBalanceLowOld EventLogType = "CREDITS_GRANT_BALANCE_LOW_OLD"
	// Deprecated, use CREDIT_GRANT_DEPLETED instead
	EventLogTypeCreditsGrantDepletedOld EventLogType = "CREDITS_GRANT_DEPLETED_OLD"
	// Deprecated, use CREDIT_GRANT_EXPIRED instead
	EventLogTypeCreditsGrantExpiredOld EventLogType = "CREDITS_GRANT_EXPIRED_OLD"
	// Deprecated, use CREDIT_GRANT_CREATED instead
	EventLogTypeCreditsGrantGrantedOld EventLogType = "CREDITS_GRANT_GRANTED_OLD"
	// Deprecated, use CREDIT_GRANT_UPDATED instead
	EventLogTypeCreditsGrantUpdatedOld EventLogType = "CREDITS_GRANT_UPDATED_OLD"
	// Credit balance depleted
	EventLogTypeCreditBalanceDepleted EventLogType = "CREDIT_BALANCE_DEPLETED"
	// Credit balance low
	...
	EventLogTypeCreditGrantCreated EventLogType = "CREDIT_GRANT_CREATED"
	// Credit grant depleted
	EventLogTypeCreditGrantDepleted EventLogType = "CREDIT_GRANT_DEPLETED"
	// Credit grant expired
	EventLogTypeCreditGrantExpired          EventLogType = "CREDIT_GRANT_EXPIRED"
	EventLogTypeCreditGrantProcessCompleted EventLogType = "CREDIT_GRANT_PROCESS_COMPLETED"
	// Credit grant updated
	EventLogTypeCreditGrantUpdated EventLogType = "CREDIT_GRANT_UPDATED"
	// Credit grant voided
	EventLogTypeCreditGrantVoided EventLogType = "CREDIT_GRANT_VOIDED"
	// Customer created
	...
	// Edge API plan cache data resync
	EventLogTypeEdgeAPIPlanCacheDataResync EventLogType = "EDGE_API_PLAN_CACHE_DATA_RESYNC"
	// Edge API product cache data resync
	EventLogTypeEdgeAPIProductCacheDataResync EventLogType = "EDGE_API_PRODUCT_CACHE_DATA_RESYNC"
	...
	EventLogTypeFeatureGroupArchived EventLogType = "FEATURE_GROUP_ARCHIVED"
	// Feature group created
	EventLogTypeFeatureGroupCreated EventLogType = "FEATURE_GROUP_CREATED"
	// Feature group un-archived
	EventLogTypeFeatureGroupUnArchived EventLogType = "FEATURE_GROUP_UN_ARCHIVED"
	// Feature group updated
	EventLogTypeFeatureGroupUpdated EventLogType = "FEATURE_GROUP_UPDATED"
	// Feature updated
	...
	// Product unarchived
	EventLogTypeProductUnarchived EventLogType = "PRODUCT_UNARCHIVED"
	// Product updated
	EventLogTypeProductUpdated EventLogType = "PRODUCT_UPDATED"
	// Promotional entitlement ends soon
	EventLogTypePromotionalEntitlementEndsSoon EventLogType = "PROMOTIONAL_ENTITLEMENT_ENDS_SOON"
	...
	// Stripe App drawer viewed
	EventLogTypeStripeAppDrawerViewed EventLogType = "STRIPE_APP_DRAWER_VIEWED"
...
var AllEventLogType = []EventLogType{
	...
	EventLogTypeAPIKeyRevoked,
	EventLogTypeAPIKeyRotated,
	EventLogTypeAPIKeyUpdated,
	EventLogTypeAutomaticRechargeConfigurationChanged,
	EventLogTypeAutomaticRechargeOperationAttempted,
	EventLogTypeCouponArchived,
	EventLogTypeCouponCreated,
	EventLogTypeCouponUpdated,
	EventLogTypeCreateSubscriptionFailed,
	EventLogTypeCreditsAutomaticRechargeLimitExceeded,
	EventLogTypeCreditsBalanceDepletedOld,
	EventLogTypeCreditsBalanceLowOld,
	EventLogTypeCreditsGrantBalanceLowOld,
	EventLogTypeCreditsGrantDepletedOld,
	EventLogTypeCreditsGrantExpiredOld,
	EventLogTypeCreditsGrantGrantedOld,
	EventLogTypeCreditsGrantUpdatedOld,
	...
	EventLogTypeCreditGrantExpired,
	EventLogTypeCreditGrantProcessCompleted,
	EventLogTypeCreditGrantUpdated,
	EventLogTypeCreditGrantVoided,
	...
	EventLogTypeEdgeAPIPlanCacheDataResync,
	EventLogTypeEdgeAPIProductCacheDataResync,
	...
	EventLogTypeFeatureGroupArchived,
	EventLogTypeFeatureGroupCreated,
	EventLogTypeFeatureGroupUnArchived,
	EventLogTypeFeatureGroupUpdated,
	...
	EventLogTypeProductUnarchived,
	EventLogTypeProductUpdated,
	EventLogTypePromotionalEntitlementEndsSoon,
	...
	EventLogTypeStripeAppDrawerViewed,
...
const (
	...
	SubscriptionQuerySortFieldsPricingType       SubscriptionQuerySortFields = "pricingType"
...
var AllSubscriptionQuerySortFields = []SubscriptionQuerySortFields{
	...
	SubscriptionQuerySortFieldsPricingType,
	...
	SubscriptionQuerySortFieldsSubscriptionID,
}
